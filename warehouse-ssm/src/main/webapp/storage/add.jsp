...
%>
<!DOCTYPE html><html><head><meta charset="UTF-8"/><title>新增仓库</title>
<link rel="stylesheet" href="<%=basePath %>css/reset.css"><link rel="stylesheet" href="<%=basePath %>css/main.css"></head><body>
<div class="formCard"><h2>新增仓库</h2>
<form action="/storage/add.do" method="post">
    <div class="formRow"><label>仓库名</label><input type="text" name="name" required></div>
